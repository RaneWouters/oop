...
struct Color {
    ...
    ~Color() { cout << "destructor of Color" << endl; }
...
class Shape {
   ...
   public:
    ...
    ~Shape() { cout << "destructor of Shape" << endl; }
...
class Point : public Shape {
   ...
   public:
    Point(double x = 0, double y = 0, const Color& c = Color())
        : Shape(c), m_x(x), m_y(y) {
...
class Circle : public Shape {
   ...
   public:
    Circle(const Point& p, double r, const Color& c = Color())
        : Shape(c), m_center(p), m_radius(r) {
        cout << "constructor of Circle" << endl;
    }
    Circle(const Circle& rhs)
        : Shape(rhs), m_center(rhs.m_center), m_radius(rhs.m_radius) {
